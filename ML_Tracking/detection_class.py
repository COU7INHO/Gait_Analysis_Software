...
class MarkerDetection:
    def __init__(self, detectFrame, confidenceValue=0.6, weightsFile="/Users/tiagocoutinho/Desktop/Gait_Software/ML_Tracking/yolov3_training_last.weights", cfgFile= "/Users/tiagocoutinho/Desktop/Gait_Software/ML_Tracking/yolov3_testing.cfg"):
    ...
    def detect(self):
        ...
        if self.detectFrame is not None:
            ...
            blob = cv2.dnn.blobFromImage(self.detectFrame, 0.00392, (320, 320), (0, 0, 0), True, crop=False)
